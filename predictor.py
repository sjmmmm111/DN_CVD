...
if st.button("Predict"):
    ...
    predicted_probe = model.predict_probe(features)[1]

    st.write(f"**Predicted Class:**{predicted_class}(1:yes,0:no)")
    st.write(f"**Predicted Probabilities:**{predicted_probe}")
    probability = predicted_probe[predicted_class]*100
